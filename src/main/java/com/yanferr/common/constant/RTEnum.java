...
public enum RTEnum {
    ...
    Lv7(7,7 * 24 * 60 * 60 * 1000L, 7 * 24 * 60 * 60 * 1000 + 24 * 60 * 60 * 1000L),
    Lv8(8,15 * 24 * 60 * 60 * 1000L, 15 * 24 * 60 * 60 * 1000 + 24 * 60 * 60 * 1000L),
    Lv9(9,30L * 24 * 60 * 60 * 1000, 30L * 24 * 60 * 60 * 1000 + 24 * 60 * 60 * 1000);
